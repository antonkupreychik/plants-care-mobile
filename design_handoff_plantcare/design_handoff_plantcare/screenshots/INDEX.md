...
Рендеры всех 38 экранов (43 файла с учётом под-шагов мастера и sheet'ов ухода) в **light** и **dark** темах. Сняты из `design/PlantCare.html` в нативном размере (412 CSS‑px ширина, полная высота экрана).
