// PlantCare — batch 5 (часть 2) — Настройки тихих часов + Лента уведомлений
  ...
  const groups = [
    {
      label: 'Сегодня', items: [
        ...
        { kind: 'alert', icon: 'heart', plant: 'Доктор PlantCare', text: 'Фернандо грустит уже 3 дня. Посмотри, что можно поправить.', meta: 'Авто‑диагностика', time: '7:30', unread: true, action: 'Открыть диагноз', tint: t.terracotta },
      ],
    },
    {
      label: 'Вчера', items: [
