...
mixin _$Streak {
 ...
 int get plantId;/// Количество on-time-уходов подряд.
 int get count;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Streak&&(identical(other.plantId, plantId) || other.plantId == plantId)&&(identical(other.count, count) || other.count == count));
}


@override
int get hashCode => Object.hash(runtimeType,plantId,count);

@override
String toString() {
  return 'Streak(plantId: $plantId, count: $count)';
}
...
/// Create a copy of Streak
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? plantId = null,Object? count = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int plantId,  int count)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Streak() when $default != null:
return $default(_that.plantId,_that.count);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int plantId,  int count)  $default,) {final _that = this;
switch (_that) {
case _Streak():
return $default(_that.plantId,_that.count);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int plantId,  int count)?  $default,) {final _that = this;
switch (_that) {
case _Streak() when $default != null:
return $default(_that.plantId,_that.count);case _:
  return null;
...
class _Streak implements Streak {
  const _Streak({required this.plantId, required this.count});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Streak&&(identical(other.plantId, plantId) || other.plantId == plantId)&&(identical(other.count, count) || other.count == count));
}
...
/// Create a copy of Streak
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? plantId = null,Object? count = null,}) {
