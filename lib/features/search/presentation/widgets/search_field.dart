...
/// Поле унифицированного поиска (экран Search, issue #69) с автофокусом и
/// дебаунсом ввода 400 мс.
///
/// Сырой ввод НЕ дёргает state на каждый символ: `onChanged` перезапускает
/// [Timer] на [debounce], и только по его истечении вызывается [onChangedDebounced]
